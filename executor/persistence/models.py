...
<<<<<<< HEAD
# ---------------------------------------------------------------------------
# Cross-database UUID type: uses PostgreSQL UUID natively, falls back to
# CHAR(36) on SQLite / other dialects.
# ---------------------------------------------------------------------------
...
class GUID(TypeDecorator):
    ...
    Uses PostgreSQL's UUID column type when available, otherwise stores as
    CHAR(36).
    """
    impl = CHAR(36)
    cache_ok = True
...
<<<<<<< HEAD
    ...
    config = Column(JSON, nullable=True)  # JSON works on both PostgreSQL and SQLite
=======
